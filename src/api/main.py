...
print("=" * 70)
print("Loading MLflow XGBoost model...")
print(f"MLflow Tracking URI : {MLFLOW_TRACKING_URI}")
...
try:
    # --------------------------------------------------------
    # Load XGBoost model directly from MLflow Model Registry
    # --------------------------------------------------------
    #
    # We use mlflow.xgboost.load_model() instead of
    # mlflow.pyfunc.load_model().
    #
    # This gives us access to the native XGBoost model API,
    # including predict() and predict_proba().
    # --------------------------------------------------------
    ...
    print("=" * 70)
    print("ERROR: Failed to load MLflow XGBoost model")
    print(f"Model URI            : {MODEL_URI}")
    print(f"MLflow Tracking URI  : {MLFLOW_TRACKING_URI}")
